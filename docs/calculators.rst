...
When using a 2- or 2+3-body force field, the ``rep_alpha`` parameter allows the user to include a Lennard-Jones like repulsive term that adds a 2-body repulsion: $$E_{rep}(r) =  0.5 ( \mathrm{rep\_alpha}/r )^{12} $$.
