...
sys.path.insert(0, os.path.abspath('..'))
sys.path.insert(0, os.path.abspath('../..'))
sys.path.insert(0, os.path.abspath('../m_ff'))
sys.path.insert(0, os.path.abspath('../../m_ff'))
...
man_pages = [
    (master_doc, 'machinelearningderivednon-parametricforcefields',
     'Machine learning derived non-parametric force fields Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Machinelearningderivednon-parametricforcefields',
     'Machine learning derived non-parametric force fields Documentation',
     author, 'Machinelearningderivednon-parametricforcefields', 'One line description of project.',
     'Miscellaneous'),
]
