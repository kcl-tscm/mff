 ...
 * Generation date: Wed Mar  7 19:36:13 2018
...
/******************************* reg_ev_energy *******************************/
static char doc_f2py_rout__tricub_reg_ev_energy[] = "\
...
/* extern void reg_ev_energy(double*,double*,double*,double*,double*,double*,double*,double*,int,int,int,int); */
static PyObject *f2py_rout__tricub_reg_ev_energy(const PyObject *capi_self,
                           PyObject *capi_args,
...
/*frompyobj*/
  ...
  if (capi_x0_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(_tricub_error,"failed in converting 1st argument `x0' of _tricub.reg_ev_energy to C/Fortran array" );
  } else {
  ...
  if (capi_f_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(_tricub_error,"failed in converting 4th argument `f' of _tricub.reg_ev_energy to C/Fortran array" );
  } else {
  ...
  if (capi_val_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(_tricub_error,"failed in converting hidden `val' of _tricub.reg_ev_energy to C/Fortran array" );
  } else {
  ...
  if (capi_x1_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(_tricub_error,"failed in converting 2nd argument `x1' of _tricub.reg_ev_energy to C/Fortran array" );
  } else {
  ...
  if (capi_x2_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(_tricub_error,"failed in converting 3rd argument `x2' of _tricub.reg_ev_energy to C/Fortran array" );
  } else {
  ...
  if (capi_fx0_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(_tricub_error,"failed in converting 5th argument `fx0' of _tricub.reg_ev_energy to C/Fortran array" );
  } else {
  ...
  if (capi_fx1_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(_tricub_error,"failed in converting 6th argument `fx1' of _tricub.reg_ev_energy to C/Fortran array" );
  } else {
  ...
  if (capi_fx2_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(_tricub_error,"failed in converting 7th argument `fx2' of _tricub.reg_ev_energy to C/Fortran array" );
  } else {
...
/******************************* reg_ev_forces *******************************/
static char doc_f2py_rout__tricub_reg_ev_forces[] = "\
...
/* extern void reg_ev_forces(double*,double*,double*,double*,double*,double*,double*,double*,double*,double*,int,int,int,int); */
static PyObject *f2py_rout__tricub_reg_ev_forces(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
...
/*frompyobj*/
  ...
  if (capi_x0_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(_tricub_error,"failed in converting 1st argument `x0' of _tricub.reg_ev_forces to C/Fortran array" );
  } else {
    x0 = (double *)(PyArray_DATA(capi_x0_tmp));
  ...
  if (capi_f_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(_tricub_error,"failed in converting 4th argument `f' of _tricub.reg_ev_forces to C/Fortran array" );
  } else {
    f = (double *)(PyArray_DATA(capi_f_tmp));
  ...
  if (capi_val_dx0_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(_tricub_error,"failed in converting hidden `val_dx0' of _tricub.reg_ev_forces to C/Fortran array" );
  } else {
  ...
  if (capi_val_dx1_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(_tricub_error,"failed in converting hidden `val_dx1' of _tricub.reg_ev_forces to C/Fortran array" );
  } else {
  ...
  if (capi_val_dx2_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(_tricub_error,"failed in converting hidden `val_dx2' of _tricub.reg_ev_forces to C/Fortran array" );
  } else {
  ...
  if (capi_x1_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(_tricub_error,"failed in converting 2nd argument `x1' of _tricub.reg_ev_forces to C/Fortran array" );
  } else {
    x1 = (double *)(PyArray_DATA(capi_x1_tmp));
  ...
  if (capi_x2_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(_tricub_error,"failed in converting 3rd argument `x2' of _tricub.reg_ev_forces to C/Fortran array" );
  } else {
    x2 = (double *)(PyArray_DATA(capi_x2_tmp));
  ...
  if (capi_fx0_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(_tricub_error,"failed in converting 5th argument `fx0' of _tricub.reg_ev_forces to C/Fortran array" );
  } else {
    fx0 = (double *)(PyArray_DATA(capi_fx0_tmp));
  ...
  if (capi_fx1_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(_tricub_error,"failed in converting 6th argument `fx1' of _tricub.reg_ev_forces to C/Fortran array" );
  } else {
    fx1 = (double *)(PyArray_DATA(capi_fx1_tmp));
  ...
  if (capi_fx2_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(_tricub_error,"failed in converting 7th argument `fx2' of _tricub.reg_ev_forces to C/Fortran array" );
  } else {
    fx2 = (double *)(PyArray_DATA(capi_fx2_tmp));
...
/********************************* reg_ev_all *********************************/
static char doc_f2py_rout__tricub_reg_ev_all[] = "\
...
"val_dx2 : rank-1 array('d') with bounds (ix)";
/* extern void reg_ev_all(double*,double*,double*,double*,double*,double*,double*,double*,double*,double*,double*,int,int,int,int); */
static PyObject *f2py_rout__tricub_reg_ev_all(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
...
/*frompyobj*/
  ...
  if (capi_x0_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(_tricub_error,"failed in converting 1st argument `x0' of _tricub.reg_ev_all to C/Fortran array" );
  } else {
    x0 = (double *)(PyArray_DATA(capi_x0_tmp));
  ...
  if (capi_f_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(_tricub_error,"failed in converting 4th argument `f' of _tricub.reg_ev_all to C/Fortran array" );
  } else {
    f = (double *)(PyArray_DATA(capi_f_tmp));
  ...
  if (capi_val_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(_tricub_error,"failed in converting hidden `val' of _tricub.reg_ev_all to C/Fortran array" );
  } else {
    val = (double *)(PyArray_DATA(capi_val_tmp));
  ...
  if (capi_val_dx0_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(_tricub_error,"failed in converting hidden `val_dx0' of _tricub.reg_ev_all to C/Fortran array" );
  } else {
    val_dx0 = (double *)(PyArray_DATA(capi_val_dx0_tmp));
  ...
  if (capi_val_dx1_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(_tricub_error,"failed in converting hidden `val_dx1' of _tricub.reg_ev_all to C/Fortran array" );
  } else {
    val_dx1 = (double *)(PyArray_DATA(capi_val_dx1_tmp));
  ...
  if (capi_val_dx2_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(_tricub_error,"failed in converting hidden `val_dx2' of _tricub.reg_ev_all to C/Fortran array" );
  } else {
    val_dx2 = (double *)(PyArray_DATA(capi_val_dx2_tmp));
  ...
  if (capi_x1_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(_tricub_error,"failed in converting 2nd argument `x1' of _tricub.reg_ev_all to C/Fortran array" );
  } else {
    x1 = (double *)(PyArray_DATA(capi_x1_tmp));
  ...
  if (capi_x2_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(_tricub_error,"failed in converting 3rd argument `x2' of _tricub.reg_ev_all to C/Fortran array" );
  } else {
    x2 = (double *)(PyArray_DATA(capi_x2_tmp));
  ...
  if (capi_fx0_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(_tricub_error,"failed in converting 5th argument `fx0' of _tricub.reg_ev_all to C/Fortran array" );
  } else {
    fx0 = (double *)(PyArray_DATA(capi_fx0_tmp));
  ...
  if (capi_fx1_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(_tricub_error,"failed in converting 6th argument `fx1' of _tricub.reg_ev_all to C/Fortran array" );
  } else {
    fx1 = (double *)(PyArray_DATA(capi_fx1_tmp));
  ...
  if (capi_fx2_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(_tricub_error,"failed in converting 7th argument `fx2' of _tricub.reg_ev_all to C/Fortran array" );
  } else {
    fx2 = (double *)(PyArray_DATA(capi_fx2_tmp));
...
static FortranDataDef f2py_routine_defs[] = {
  {"reg_ev_energy",-1,{{-1}},0,(char *)reg_ev_energy,(f2py_init_func)f2py_rout__tricub_reg_ev_energy,doc_f2py_rout__tricub_reg_ev_energy},
  {"reg_ev_forces",-1,{{-1}},0,(char *)reg_ev_forces,(f2py_init_func)f2py_rout__tricub_reg_ev_forces,doc_f2py_rout__tricub_reg_ev_forces},
  {"reg_ev_all",-1,{{-1}},0,(char *)reg_ev_all,(f2py_init_func)f2py_rout__tricub_reg_ev_all,doc_f2py_rout__tricub_reg_ev_all},
